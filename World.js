...
WALL.src    = "wall.png";
POINT.src   = "point.png";
LPACMAN.src = "lpacman.png";
UPACMAN.src = "upacman.png";
RPACMAN.src = "rpacman.png";
DPACMAN.src = "dpacman.png";
...
document.onkeydown = function(event){
    ...
    switch(key){
    	case ARROW_KEY_UP:
        case W:
            if(Pacman.isMove(Pacman.x, Pacman.y - 1)){
        ...
        case ARROW_KEY_LEFT:
        case A:
            if(Pacman.isMove(Pacman.x - 1, Pacman.y)){
